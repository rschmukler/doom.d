...
(def-doom-theme doom-dream-gradient
  ...
  ((bg         '("#141420" nil       nil            ))
   ...
   (grey       base4)
   (red        '("#694d62" "#ff6655" "red"          ))
   (orange     '("#9c758f" "#dd8844" "brightred"    ))
   (green      '("#4b7270" "#99bb66" "green"        ))
   (teal       '("#6f8e8c" "#44b9b1" "brightgreen"  ))
   (yellow     '("#b87b76" "#ECBE7B" "yellow"       ))
   (blue       '("#6b96b7" "#51afef" "brightblue"   ))
   (dark-blue  '("#497fa8" "#2257A0" "blue"         ))
   (magenta    '("#666ca7" "#c678dd" "magenta"      ))
   (violet     '("#8186b7" "#a9a1e1" "brightmagenta"))
   (cyan       '("#53abab" "#46D9FF" "brightcyan"   ))
   ...
   (error          (doom-lighten orange 0.5))
   (warning        yellow)
   (success        (doom-lighten green 0.5))
   (vc-modified    orange)
   (vc-added       (doom-lighten green 0.5))
   (vc-deleted     orange)
